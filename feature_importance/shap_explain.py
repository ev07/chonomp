...
save_dir = "./results/shap_explain/"+dataset+"/"

fs_version  ="NoSelection"
cls_version = "KNeighborsRegressorModel"
...
fs = {"GroupLasso":GroupLasso,"NoSelection":NoSelection,"ChronOMP":ChronOMP}[fs_version](config, target)
fs.fit(data_train)
