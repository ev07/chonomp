...
from experiments2.routines import compute_stats_selected

from baselines.feature_selection import MultiSetChronOMP, VectorLassoLars, GroupLasso, NoSelection
    ...
    for dataset in datasets:
        ...
        for i,filename in enumerate(filelist):
            ...
            for target in target_set:
                ...
                if not os.path.isfile("../experiments2/results/optuna/test_stats/"+result_filename):  # in case the file wasn't computed
                    continue
