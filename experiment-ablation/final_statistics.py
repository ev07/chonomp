...
#####
#
#   Ablation specific part
#
#####

def run_best_configs_test_set_ablation(dataset, filename, target, configs, special_config):
    """
    With the special config argument, specify the sample size and covariate size
    """
    data_config = setup_dataset(dataset, filename, target)
    data_config["DATASET"]["HOLDOUT"]=False
    data_config["DATASET"] = {**data_config["DATASET"], **special_config}
